...
function Hero() {
  return (
    <section className="hero p-5 md:p-20 mt-8 min-h-screen flex flex-column items-center">
        <div className="row">
            <div className="col-md-8">
                ...
                <p className="text-xl/8 md:text-2xl/8 mt-3 text-gray-300"> Trusted partner in data enrichment, classification, and governance for global supply chains, hospitals, and manufacturers.</p>
               <div className="flex gap-1 md:gap-4 flex-wrap mt-4 md:mt-6">
